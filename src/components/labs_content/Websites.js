...
class WebsitesCountryChart extends React.Component {
    ...
    handleCountryTab(e, { value }) {
        ...
        trackEvent('Labs Page', `Changed Country Chart tab to ${e.currentTarget.value}`)                 // Track Event on Google Analytics    
    }
...
class WebsitesGlobalChart extends React.Component {
    ...
    handleGlobalTab(e, { value }) {
        ...
        trackEvent('Labs Page', `Changed Chart to Wallet ${e.currentTarget.value}`)                 // Track Event on Google Analytics    
    }
